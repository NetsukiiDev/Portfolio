...
export const setupTranslations: Record<WizardLang, SetupText> = {
  en: {
    ...
    site: {
      ...
      saving: "Saving…",
      genericError: "Something went wrong",
      tabs: { site: "Portfolio", appearance: "Appearance", storage: "Storage" },
  ...
  it: {
    ...
    site: {
      ...
      saving: "Salvataggio…",
      genericError: "Qualcosa è andato storto",
      tabs: { site: "Portfolio", appearance: "Aspetto", storage: "Storage" },
  ...
  zh: {
    ...
    site: {
      ...
      saving: "保存中…",
      genericError: "出错了",
      tabs: { site: "Portfolio", appearance: "外观", storage: "存储" },
      palette: "配色方案",
      storageProvider: "提供商",
  ...
  es: {
    ...
    site: {
      ...
      saving: "Guardando…",
      genericError: "Algo salió mal",
      tabs: { site: "Portfolio", appearance: "Apariencia", storage: "Almacenamiento" },
  ...
  ar: {
    ...
    site: {
      ...
      saving: "جارٍ الحفظ…",
      genericError: "حدث خطأ ما",
      tabs: { site: "Portfolio", appearance: "المظهر", storage: "التخزين" },
  ...
  pt: {
    ...
    site: {
      ...
      saving: "Salvando…",
      genericError: "Algo deu errado",
      tabs: { site: "Portfolio", appearance: "Aparência", storage: "Armazenamento" },
  ...
  ru: {
    ...
    site: {
      ...
      saving: "Сохранение…",
      genericError: "Что-то пошло не так",
      tabs: { site: "Portfolio", appearance: "Оформление", storage: "Хранилище" },
  ...
  ja: {
    ...
    site: {
      ...
      saving: "保存中…",
      genericError: "問題が発生しました",
      tabs: { site: "Portfolio", appearance: "外観", storage: "ストレージ" },
      palette: "カラーパレット",
  ...
  fr: {
    ...
    site: {
      ...
      genericError: "Une erreur est survenue",
      tabs: { site: "Portfolio", appearance: "Apparence", storage: "Stockage" },
  ...
  de: {
    ...
    site: {
      ...
      genericError: "Etwas ist schiefgelaufen",
      tabs: { site: "Portfolio", appearance: "Erscheinungsbild", storage: "Speicher" },
      palette: "Farbpalette",
